...
IE_RADIO_PRIORITY_LCS       = 151
IE_RAT_TYPE                 = 152
IE_USER_LOCATION_INFO       = 153
IE_MS_TIME_ZONE             = 154
IE_IMEI_SV                  = 155
IE_CAMEL_CHARGING_INFO_CONT = 156
IE_MBMS_UE_CTX              = 157
IE_TMGI                     = 158
IE_RIM_ROUTING_ADDRESS      = 159
IE_MBMS_PROTOCOL_CONFIG     = 160
IE_MBMS_SERVICE_AREA        = 161
IE_SRC_RNC_PDCP_CTX_INFO    = 162
IE_ADDITIONAL_TRACE_INFO    = 163
IE_HOP_COUNTER              = 164
IE_SEL_PLMN_ID              = 165
IE_MBMS_SESSION_ID          = 166
IE_MBMS_2G_3G_IND           = 167
IE_ENHANCED_NSAPI           = 168
IE_MBMS_SESSION_DURATION    = 169
IE_MBMS_TIME_TO_DATA_XFER   = 170
IE_LHN_ID                   = 171
IE_MBMS_SESSION_REPETITION_NUM = 172
IE_MBMS_TIME_TO_DATA_XFER2  = 173
IE_BSS_CONTAINER            = 174
IE_CELL_ID                  = 175
IE_PDU_NUMBERS              = 176
IE_BSSGP_CAUSE              = 177
IE_REQ_MBMS_BEARER_CAP      = 178
IE_RIM_ROUTING_ADDR_DISC    = 179
IE_LIST_OF_SETUPS           = 180
IE_PS_HANDOVER_XID_PARAMS   = 181
IE_MS_INFO_CHANGE_REP_ACTION = 182
IE_DIRECT_TUNNEL_FLAGS      = 183
IE_CORRELATION_ID           = 184
IE_BEARER_CONTROL_MODE      = 185
IE_MBMS_FLOW_ID             = 186
IE_MBMS_IP_MCAST_DIST       = 187
IE_MBMS_DIST_ACK            = 188
IE_RELIABLE_INTER_RAT_HO_INFO = 189
IE_RFSP_INDEX               = 190
IE_FQDN                     = 191
IE_EVOLVED_ALLOCATION_RETENTION_1 = 192
IE_EVOLVED_ALLOCATION_RETENTION_2 = 193
IE_EXTENDED_COMMON_FLAGS    = 194
IE_UCI                      = 195
IE_CSG_INFO_REP_ACTION      = 196
IE_CSG_ID                   = 197
IE_CMI                      = 198
IE_APCO                     = 199
IE_UE_NETWORK_CAPABILITY    = 200
IE_UE_AMBR                  = 201
IE_APN_AMBR_WITH_NSAPI      = 202
IE_GGSN_BACK_OFF_TIME       = 203
IE_SIG_PRIO_INDICATION      = 204
IE_SIG_PRIO_INDICATION_NSAPI = 205
IE_HIGHER_BITRATES_THAN_16M_FLAG = 206
IE_MAX_MBR_APN_AMBR         = 207
IE_ADDITIONAL_MM_CTX_SRVCC  = 208
IE_ADDITIONAL_FLAGS_SRVCC   = 209
IE_STN_SR                   = 210
IE_SRC_TGT_TRANS_CON        = 211
IE_TGT_SRC_TRANS_CON        = 212
IE_MM_CON_EUTRAN_SRVCC      = 213
IE_MM_CON_UTRAN_SRVCC       = 214
IE_SRVCC_CAUSE              = 215
IE_TGT_RNC_ID               = 216
IE_TGT_GLOBAL_CELL_ID       = 217
IE_TEID_C_SRVCC             = 218
IE_SV_FLAGS                 = 219
IE_SAI_SRVCC                = 220
IE_LHN_ID_W_NSAPI           = 221
IE_CN_OPERATOR_SEL_ENT      = 222
IE_UE_USAGE_TYPE            = 223
IE_EXTENDED_COMMON_FLAGS_2  = 224
IE_NODE_IDENTIFIER          = 225
IE_CIOT_OPT_SUPPORT_IND     = 226
IE_SCEF_PDN_CONNECTION      = 227
IE_IOV_UPDATES_COUNTER      = 228
IE_MAPPED_UE_USAGE_TYPE     = 229
IE_UP_FUNCTION_SEL_IND_FLAGS = 230
IE_PRIVATE_EXT              = 255
